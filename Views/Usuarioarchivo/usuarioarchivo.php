...
?>
      ...
      <div class="admin-layer--content">
        ...
        <div class="row flex g-10 justify-right mr-bottom-10">
          <button class="btn btn--medium bg-blue" data-fancybox data-src="#modalFormUsuarioArchivo" onclick="openModal()">
          ...
          <div class="table-pro-content"> 
                        ...
                        <tr>
                          <td>
                            <div class="selected-article"> 
                              <label>
                                <input type="radio" name="ckUsuarioArchivo" data-id="<?=$arrRegistros[$p]['id_usuario_archivo']?>"><span>&nbsp;</span>
                              </label>
                            </div>
                          </td>
                          <td><?=$arrRegistros[$p]['id_usuario_archivo']?></td>
            ...
            <div class="footer-pagination">
                ...
                <div class="pagination-datatable">
                  <a class="button-small-arrow arrow-left" href="<?= ($data['pagina']==1) ? "#" : base_url()."/garchivos/page/".($data['pagina']-1) ?>"> <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.5 11L6.5 8L9.5 5" stroke="#868FA0" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></a>

                  <div class="total-pages"><?= $data['pagina'] ?> / <?= $data['total_paginas'] ?>
                  </div>
                  <a class="button-small-arrow arrow-right" href="<?= base_url() ?>/garchivos/page/<?= ($data['pagina']< $data['total_paginas']) ? $data['pagina']+1 : $data['total_paginas'] ?>"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M6.5 11L9.5 8L6.5 5" stroke="#464F60" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></a>
                </div>
            </div>
          </div>
        </div>
  ...
  <?php getModal('modalUsuarioArchivo',$data);?>
</div>
