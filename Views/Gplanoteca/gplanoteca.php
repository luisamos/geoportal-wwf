...
<div class="admin-layer--content">
    ...
    <div class="row flex g-10 justify-right mr-bottom-10">
        <button class="btn btn--medium bg-blue" data-fancybox data-src="#modalFormPlanoteca" onclick="openModal()">
                    ...
                    <tr>
                        <td>
                            <div class="selected-article">
                                <label>
                                    <input type="radio" name="ckPlanoteca"
                                        data-id="<?=$arrRegistros[$p]['id_planoteca']?>"
                                        data-programa="<?=$arrRegistros[$p]['planot_id_tipo']?>"
                                        data-codigo="<?=$arrRegistros[$p]['planot_codigo']?>"
                                        data-nombre="<?=$arrRegistros[$p]['planot_nombre']?>"><span>&nbsp;</span>
                                </label>
                            </div>
                        </td>
                        <td><?=$arrRegistros[$p]['id_planoteca']?></td>
                        <td><?=$arrRegistros[$p]['progra_nombre']?></td>
                        <td><?=$arrRegistros[$p]['planot_codigo']?></td>
                        <td><?=$arrRegistros[$p]['planot_nombre']?></td>
                        <td class="text-center">
                            <a href="<?=$arrRegistros[$p]['planot_archivo']?>" target="_blank">
                                <button class="btn-sm">
                        ...
                        <td style="text-align: center;" class="text-center">
                            <img src="<?= media()?>/images/uploads/<?=$arrRegistros[$p]['planot_img']?>"
                                style="max-width: 50%;" />
                        </td>
                        <td><?=$arrRegistros[$p]['planot_tag']?></td>
                    </tr>
                    <?php 
                          } 
                      ?>
            ...
            <div class="footer-pagination">
                ...
                <div class="pagination-datatable">
                    <a class="button-small-arrow arrow-left"
                        href="<?= ($data['pagina']==1) ? "#" : base_url()."/gplanoteca/page/".($data['pagina']-1) ?>">
                    ...
                    <a class="button-small-arrow arrow-right"
                        href="<?= base_url() ?>/gplanoteca/page/<?= ($data['pagina']< $data['total_paginas']) ? $data['pagina']+1 : $data['total_paginas'] ?>"><svg
