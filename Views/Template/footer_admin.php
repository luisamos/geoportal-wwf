    <footer class="footer">
      <div class="container">
        <div class="footer-details flex between">
          <div class="footer-details__wrap-logo-button flex g-30 align-center">
            ...
            <div class="label-wwf">Por un futuro en el que los<br> humanos vivan en armonía<br> con la naturaleza.</div>
          </div>
      ...
      <div class="more-footer-details">
        <div class="container">Fotos y gráficos © WWF o usados con permiso. Texto disponible bajo <a href="http://creativecommons.org/licenses/by-sa/3.0/deed.es" target="_blank">licencia de Creative Commons</a>.</div>
      </div>
    </footer>
