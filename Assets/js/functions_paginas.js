...
// funcion para obtener el text tarea personalido
tinymce.init({
...
//si
//si existe el elemento formPaginas
if(document.querySelector("#formPaginas")){
    // se creara una variable para que tome como valor todo el formulario 
    let formPaginas = document.querySelector("#formPaginas");
    // funcion para prevenir queno se recargue la pagina
    formPaginas.onsubmit = function(e) {
        e.preventDefault();
        // almacenamos el valor de todos los elementos input
        let strTitulo = document.querySelector('#txtTitulo').value;
        let strContenido = document.querySelector('#txtContenido').value;
        let intStatus = document.querySelector('#listStatus').value;
        //validamos si el valor alamcenado en las variables es vacio
        if(strTitulo == '' || strContenido == '' || intStatus == '' )
        {
            //si estan vacios estonces lazamos una alerta
            swal("Atención", "Todos los campos son obligatorios." , "error");
            return false;
        }
        // implementamos el loading
        divLoading.style.display = "flex";
        //pasamos todo el contenido que escribimos en el editor
        tinyMCE.triggerSave();
        //enviamso los datos por ajax
